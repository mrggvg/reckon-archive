-- 0001 — baseline.
--
-- The schema as it stood when migrations were adopted. Never edit this file
-- again: every later change is a new numbered file, so a database that has
-- already run this one can be brought forward without being rebuilt.
--
-- Conventions:
